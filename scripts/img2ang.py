...
# output is 2 degree
model.add(Dense(units= sample_deg.shape[1], 
                # kernel_regularizer = regularizers.l1_l2(l1=1e-5, l2=1e-4),
                # bias_regularizer = regularizers.l2(1e-4),
                # activity_regularizer = regularizers.l2(1e-5),
                kernel_initializer = initializers.RandomNormal(stddev=0.01),
...
model.load_weights("/home/zgl/Desktop/trained model/Oct18_weights")
...
def Imagecallback(msg):
    ...
    global image1, center_x_list, rot_list, predict_list, predict_list1
    ...
    if center_x_list_record == 1:
        ...
        rot_list.append((rot[1]))
        predict_list.append(pred)
        # predict_list.append(pred[0, 0])
...
def on_release(key):
    if key == keyboard.Key.esc:
        ...
        global point_cont, point_pair, pred, rot,center_x_list_record, rot_list, center_x_list, time_init, predict_list, predict_list1
        if center_x_list_record == 0:
            ...
            print(center_x_list)
            print(rot_list)
            np.save("/home/zgl/Desktop/result/1014/predict/center_x_list.npy", np.asarray(center_x_list))
            np.save("/home/zgl/Desktop/result/1014/predict/predict_list.npy", np.asarray(predict_list))
            # np.save("/home/zgl/Desktop/result/1014/predict/predict_list1.npy", np.asarray(predict_list1))
            np.save("/home/zgl/Desktop/result/1014/predict/rot_list.npy", np.asarray(rot_list))
            # np.savetxt("/home/zgl/Desktop/result/1014/predict/.csv", np.predict, delimiter=",")
            np.save("/home/zgl/Desktop/result/1014/predict/time.npy", np.asarray([time.time()-time_init]))
